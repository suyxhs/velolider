...
const Transparency = () => {
  return (
    <main className="px-container prose-custom mx-auto !max-w-container pb-24 pt-5">
      ...
      <h3>2. Условия и цели обработки персональных данных</h3>
      <p>
      ...
      <h3>3. Порядок ввода в действие и изменения Положения</h3>
      <p>
      ...
      <h3>4. Цели обработки информации</h3>
      <p>
      ...
      <h3>5. Состав персональных данных</h3>
      <p>
      ...
      <p>
        6.1. Обработка персональных данных осуществляется на основе следующих принципов: <br />

        - законности целей и способов обработки персональных данных; <br />

        - добросовестности; <br />

        - соответствия целей обработки персональных данных целям, заранее определенным и заявленным при сборе персональных данных, а также полномочиям Администрации Сайта; <br />
      ...
      <h3>7. Меры по защите информации о Пользователях.</h3>
      <p>
        7.1. Администрация Сайта принимает технические и организационно-правовые меры в целях обеспечения защиты персональных данных Пользователя от неправомерного или случайного доступа к ним, уничтожения, изменения, блокирования, копирования, распространения, а также от иных неправомерных действий.
      </p>

      <h3>8. Ограничение действия Правил.</h3>
      <p>
