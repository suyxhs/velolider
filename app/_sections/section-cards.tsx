...
export function SectionCards() {
    return(
        ...
        <section className="w-full pb-20">
            ...
            <h2 className="text-center text-4xl font-semibold text-black mb-56">Добро пожаловать в <span className="text-green-title-card">команду</span></h2>
            <div className="relative w-full max-w-area-cards h-area-cards mx-auto">
                ...
                <Image src={Card02} className="absolute left-0 bottom-32" alt="Card02" />
                <Image src={Card03} className="absolute bottom-0 left-80" alt="Card03" />
                <Image src={Card04} className="absolute top-0 right-32" alt="Card04" />
                <Image src={Card05} className="absolute right-0 bottom-28" alt="Card05" />
                <Image src={Card06} className="absolute bottom-0 right-80" alt="Card06" />
            </div>
        </section>
        </>
    )
